...
// UCID: 30087243 
 ...
 function handleCellClick() {
     const cell = this; // 'this' refers to the clicked cell
         ...
         if(canPlaceToken(currentPlayerElement, cell, imageClick)) {
             ...
             if (checkForWinner()) {
                 // clearBoard();
                 // Handle the case where a player wins
                 // You can display a winner screen or take appropriate actions
             } else {
 ...
 function canPlaceToken(currentPlayerElement, cell, imageClick) {
     const playerCell = cell.textContent; // Get the element of the cell
     const cellImg = imageClick;
     if (playerCell === '') {
